...
| `part5_power.md` + `part5_power_manifest.json` | `tools/experiments/tooling/build_spinoza_corpus.py --part 5` | Part V ("Of the Power of the Intellect, or of Human Liberty"), 220 sentence-chunks, labels `PART5_POWER_*`, 42/42 propositions; ends at the "End of the Ethics" boundary. |
