# Traianus — Audit Findings (Detailed)

**This document contains the detailed findings** (measured data, code snippets, fix implementations) from the Traianus technical audit.

The executive summary, findings summary table, and remediation status are in [`TRAIANUS_AUDIT.md`](./TRAIANUS_AUDIT.md).
